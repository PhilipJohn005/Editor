...
type QuickAction = {
  ...
  label: string
  description?: string
  // If you pass your own actions, this will run on click
  action?: () => void
  icon: React.ReactNode
}

// Default quick actions (replace or extend via props if needed)
...
// Keep this name for compatibility with your imports
export function ChartAreaInteractive({
  actions = DEFAULT_ACTIONS,
  onAction, // optional callback: (id) => void
}: {
  actions?: QuickAction[]
