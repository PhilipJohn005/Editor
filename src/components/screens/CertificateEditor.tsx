...
import CertificateImage from '../certificate/CertificateImage';
import DeleteComponent from '../certificate/DeleteComponent';
import CertificateSidebar from '../certificate/CertificateSidebar';
import { handleMoving, clearGuideLines } from '../certificate/Snapping';
import LayerList from '../certificate/LayerList';
import Export from '../certificate/Export';
  ...
  return (
    <div className="bg-gray-200 min-h-screen flex"> 
      <div className="min-h-screen flex"> 
        <CertificateSidebar sidebarImages={sidebarImages} canvas={canvas} certId={certId} />
      </div>
      ...
      <div className="flex-1 overflow-auto relative"> 
        ...
        <button onClick={addRectangle} className="absolute bg-red-500 px-4 py-2 rounded text-white" style={{ bottom: '50%', right: '20%' }}>
          Add Rectangle
        </button>
        ...
        <div className="absolute top-4 right-4 flex gap-2">
          <button onClick={() => handleZoom('in')} className="bg-blue-500 text-white px-3 py-2 rounded">
            Zoom In
          </button>
          <button onClick={() => handleZoom('out')} className="bg-blue-500 text-white px-3 py-2 rounded">
            Zoom Out 
          </button>
          <div className="text-center text-sm bg-white px-2 py-1 rounded">
