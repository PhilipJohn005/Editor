...
const Features06Page = () => {
  ...
  return (
    <div className="relative min-h-screen pt-34 flex items-center justify-center">
      <div className="absolute left-24 top-16 right-24 h-px bg-gray-300" />
      <div className="max-w-(--breakpoint-lg) w-full py-10 px-6">
        <h2 className="text-4xl md:text-[2.75rem] md:leading-[1.2] text-black font-semibold tracking-[-0.03em] sm:max-w-xl text-pretty sm:mx-auto sm:text-center">
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="basis-1/2 shrink-0">
                ...
                <h4 className="my-3 text-2xl font-semibold text-black tracking-tight">
                  {feature.title}
                </h4>
