...
const Hero02 = () => {
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center">
      <div className="absolute left-24 top-26 right-24 h-px bg-gray-300" />
      <div className="absolute left-24 bottom-2 right-24 h-px bg-gray-300" />
      <div className="max-w-(--breakpoint-xl) w-full mx-auto grid lg:grid-cols-2 gap-12 px-6 pt-12">
        <div>
          ...
          <div className="mt-12 flex items-center gap-4">
            <Button size="lg" className="rounded-full text-base" onClick={()=>navigate('/login')}>
