...
export default function IntegrationsSection() {
    return (
        <section className='relative'>
            <div className="absolute left-24 top-16 right-24 h-px bg-border" />
            <div className="py-32">
...
const IntegrationCard = ({ title, description, children = 'https://github.com/meschacirung/cnblocks' }: { title: string; description: string; children: React.ReactNode; link?: string }) => {
    return (
        <Card className="p-6">
