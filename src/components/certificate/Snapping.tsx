...
export const handleMoving = (canvas: any, obj: any, guideLines: any, setGuideLines: any) => {
...
export const createVerticalGuideline = (canvas: any, x: number, id: string) => {
...
export const createHorizontalGuideline = (canvas: any, y: number, id: string) => {
...
const guidelineExists = (canvas: any, id: string) => {
    const objects = canvas.getObjects();
